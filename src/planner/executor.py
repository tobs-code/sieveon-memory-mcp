...
class RetrievalExecutor:
    ...
    async def execute_strategy(self, strategy: RetrievalStrategy, query: str, 
        ...
        try:
            ...
            if strategy == RetrievalStrategy.EVENT_LOG_FIRST:
                ...
                result = await self._execute_semantic_hybrid(query, budget_tracker, **kwargs)
                num_queries += 2
            else:
    ...
    async def _execute_semantic_hybrid(self, query: str, budget_tracker: BudgetTracker, **kwargs) -> Dict[str, Any]:
        ...
        known_entity_names = {e.get("name", "").lower() for e in expanded_entities if e.get("name")}
