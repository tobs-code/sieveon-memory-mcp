...
class BaseEmbeddingService:
    """Abstract base class for embedding services in STRATA"""
    ...
    def embed_batch(self, texts: List[str], for_storage: bool = True) -> List[List[float]]:
